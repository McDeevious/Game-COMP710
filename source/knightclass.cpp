...
bool KnightClass::Initialise(Renderer& renderer)
{
    ...
    m_knightIdle = renderer.CreateAnimatedSprite("../game/assets/Sprites/Characters/Swordsman/Swordsman/Swordsman-Idle.png");
    if (m_knightIdle)
    {
    ...
    m_knightWalk = renderer.CreateAnimatedSprite("../game/assets/Sprites/Characters/Swordsman/Swordsman/Swordsman-Walk.png");
    if (m_knightWalk)
    {
    ...
    m_knightHurt = renderer.CreateAnimatedSprite("../game/assets/Sprites/Characters/Swordsman/Swordsman/Swordsman-Hurt.png");
    if (m_knightHurt)
    {
    ...
    m_knightDeath = renderer.CreateAnimatedSprite("../game/assets/Sprites/Characters/Swordsman/Swordsman/Swordsman-Death.png");
    if (m_knightDeath)
    {
    ...
    //Load Attack 1
    m_knightAttack1 = renderer.CreateAnimatedSprite("../game/assets/Sprites/Characters/Swordsman/Swordsman/Swordsman-Attack01.png");
    if (m_knightAttack1)
    {
    ...
    //Load Attack 2
    m_knightAttack2 = renderer.CreateAnimatedSprite("../game/assets/Sprites/Characters/Swordsman/Swordsman/Swordsman-Attack02.png");
    if (m_knightAttack2)
    {
    ...
    //Load Special Attack
    m_knightSpecial = renderer.CreateAnimatedSprite("../game/assets/Sprites/Characters/Swordsman/Swordsman/Swordsman-Attack3.png");
    if (m_knightSpecial)
    {
