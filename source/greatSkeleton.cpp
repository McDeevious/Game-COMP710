...
bool GreatSkeleton::Initialise(Renderer& renderer) {
    ...
    LogManager::GetInstance().Log("Initializing GreatSkeleton sprites...");

    //Load idle sprite
    m_skeletonIdle = renderer.CreateAnimatedSprite("../game/assets/Sprites/Skeleton/Greatsword Skeleton/Greatsword Skeleton-Idle.png");
    if (m_skeletonIdle) {
    ...
    //Load walking sprite
    m_skeletonWalk = renderer.CreateAnimatedSprite("../game/assets/Sprites/Skeleton/Greatsword Skeleton/Greatsword Skeleton-Walk.png");
    if (m_skeletonWalk) {
    ...
    //Load hurt sprite
    m_skeletonHurt = renderer.CreateAnimatedSprite("../game/assets/Sprites/Skeleton/Greatsword Skeleton/Greatsword Skeleton-Hurt.png");
    if (m_skeletonHurt) {
    ...
    //Load death sprite
    m_skeletonDeath = renderer.CreateAnimatedSprite("../game/assets/Sprites/Skeleton/Greatsword Skeleton/Greatsword Skeleton-Death.png");
    if (m_skeletonDeath) {
    ...
    //Load attack1 sprite
    m_skeletonAttack1 = renderer.CreateAnimatedSprite("../game/assets/Sprites/Skeleton/Greatsword Skeleton/Greatsword Skeleton-Attack01.png");
    ...
    //Load attack2 sprite
    m_skeletonAttack2 = renderer.CreateAnimatedSprite("../game/assets/Sprites/Skeleton/Greatsword Skeleton/Greatsword Skeleton-Attack02.png");
