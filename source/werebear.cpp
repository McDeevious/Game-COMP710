...
bool Werebear::Initialise(Renderer& renderer) {
    ...
    if (m_werewolfIdle) {
        ...
        m_werewolfIdle->SetScale(14.5f, -14.5f);
    }
    ...
    if (m_werewolfWalk) {
        ...
        m_werewolfWalk->SetScale(14.5f, -14.5f);
    }
    ...
    if (m_werewolfHurt) {
        ...
        m_werewolfHurt->SetScale(14.5f, -14.5f);
    }
    ...
    if (m_werewolfDeath) {
        ...
        m_werewolfDeath->SetScale(14.5f, -14.5f);
    }
    ...
    if (m_werewolfAttack1) {
        ...
        m_werewolfAttack1->SetScale(14.5f, -14.5f);
    }
    ...
    if (m_werewolfAttack2) {
        ...
        m_werewolfAttack2->SetScale(14.5f, -14.5f);
    }
